...
public class PieChartRenderer extends DataRenderer {
    ...
    protected float calculateMinimumRadiusForSpacedSlice(
        ...
        // This is the base of the contained menu_triangle
        double basePointsDistance = Math.sqrt(
                Math.pow(arcEndPointX - arcStartPointX, 2) +
                        Math.pow(arcEndPointY - arcStartPointY, 2));

        // After reducing space from both sides of the "slice",
        //   the angle of the contained menu_triangle should stay the same.
        // So let's find out the height of that menu_triangle.
        ...
        // And now subtract the height of the arc that's between the menu_triangle and the outer circle
